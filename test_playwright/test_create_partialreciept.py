...
PO_NUMBER = "PO194"  # Changed from PR_TITLE to reflect the search term
QUANTITY_TO_RECEIVE = "8" # Added a parameter for the quantity
...
def test_create_receipt_from_po():
    with sync_playwright() as p:
        ...
        page.locator("input[name=\"_w3csmd\"]").fill(QUANTITY_TO_RECEIVE)
        page.locator("input[name=\"_w3csmd\"]").click()
        time.sleep(5)
