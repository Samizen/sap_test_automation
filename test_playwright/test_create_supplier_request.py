...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("textbox", name="Password").fill("Iam@maitri098")
    ...
    page.locator("iframe[name=\"SMFrame\"]").content_frame.get_by_role("textbox", name="Supplier Full Legal Name").fill("Test for auto")
